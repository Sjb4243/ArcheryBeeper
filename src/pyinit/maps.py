...
def generate_keymaps(appstate, ActionQueue, Action, Countdown):
    def handle_escape():
        appstate.exit = True
    def handle_space():
        appstate.skip = True
    ...
    main_menu_keys =  {
        ...
        pygame.K_f: ActionQueue(appstate, walking_action, shooting_action, walking_action, shooting_action, collect_action),
        pygame.K_1: ActionQueue(appstate, walking_action, shooting_action),
        pygame.K_c: ActionQueue(appstate, collect_action),
